...
import { useUploadThing } from '@/lib/ploadthing';
...
const AccountProfile = ({ user, btnTitle }: Props) => {
  ...
  const onSubmit = async(values: z.infer<typeof UserValidation>) => {
    const value = values.profile_photo;

    const imageChanged = isBase64Image(value);
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className='flex items-center gap-3 w-full'>
              <FormLabel className='text-base-semibold text-light-2 mr-10'>
                Name
              </FormLabel>
              <FormControl className='flex-1 text-base-semibold text-gray-200'>
                <Input
...
<FormField
          ...
          render={({ field }) => (
            <FormItem className='flex items-center gap-3 w-full'>
              <FormLabel className='text-base-semibold text-light-2 mr-2'>
                username
              </FormLabel>
              <FormControl className='flex-1 text-base-semibold text-gray-200'>
                <Input
